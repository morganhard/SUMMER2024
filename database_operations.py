...
def save_csv_message(chat_history_id, sender_type, csv_data):
    ...
    cursor.execute('INSERT INTO messages (chat_history_id, sender_type, message_type, blob_content) VALUES (?, ?, ?, ?)',
                   (chat_history_id, sender_type, 'csv', sqlite3.Binary(csv_data.encode('utf-8'))))
    conn.commit()
...
def load_messages(chat_history_id):
    ...
    for message in messages:
        ...
        elif message_type == ["image", "audio", "csv"]:
